...
@NgModule({
  ...
  providers: [{ provide: RouteReuseStrategy, useClass: IonicRouteStrategy },Globalization,FirebaseMessaging,Camera,Network,Chooser,Device,FileTransfer,FilePath,AndroidPermissions,StatusBar,SQLite,File,BackgroundMode],
